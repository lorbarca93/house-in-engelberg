...
class AnalysisTester:
    ...
    def run_all_tests(self):
        ...
        try:
            ...
            print(f"Dashboard saved to: output/test_dashboard.html")
            print("=" * 80)
    ...
    def test_sensitivity_analysis(self):
        ...
        try:
            ...
            try:
                ...
                df_occ = run_sensitivity_analysis.sensitivity_occupancy_rate(
            ...
            try:
                npv_irr = run_sensitivity_analysis.calculate_npv_irr_for_config(
    ...
    def test_monte_carlo(self):
        ...
        try:
            ...
            try:
                df_mc = run_monte_carlo.run_monte_carlo_simulation(
                    self.base_config, 
            ...
            if test.passed and self.monte_carlo_results is not None:
                ...
                try:
                    stats = run_monte_carlo.calculate_statistics(self.monte_carlo_results)
    ...
    def test_cross_validation(self):
        ...
        try:
            ...
            if self.base_case_results:
                ...
                try:
                    base_npv_irr = run_sensitivity_analysis.calculate_npv_irr_for_config(
                        self.base_config, discount_rate=0.04
                    )
...
"""
        ...
        # Write to file
        output_path = "output/test_dashboard.html"
